...
void SysTick_Handler(void)
{
  ...
  temp_SysTick_t.EXC = STACKING->EXC;
  temp_SysTick_t.R0 = STACKING->R0;
  temp_SysTick_t.R1 = STACKING->R1;
  temp_SysTick_t.R2 = STACKING->R2;
  temp_SysTick_t.R3 = STACKING->R3;
  temp_SysTick_t.R12 = STACKING->R12;
  temp_SysTick_t.LR = STACKING->LR;
  temp_SysTick_t.Return_Addr = STACKING->Return_Addr;
  temp_SysTick_t.xPSR = STACKING->xPSR;
